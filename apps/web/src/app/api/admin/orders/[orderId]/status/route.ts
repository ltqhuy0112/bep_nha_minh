...
import { OrderApiError, updateOrderStatus } from "@bep-nha-minh/api/services/admin-orders";
...
export async function PATCH(
  ...
  try {
    ...
    const parsedBody = updateOrderStatusSchema.safeParse(await parseJson(request));
    ...
    return handleMutationError(error, "Failed to update order status");
  }
}
